...
<html>
	<head>
		...
		<meta http-equiv="Refresh" content="10;url=view.php">
	</head>
	<body>
		<div id="header">
			<div id="header_top">
			...
			<div id="header_menu">
				<ul id="menu_list">
					...
					<li class="menu_item" > <a class="menu_link" href="view.php">ΠΡΟΒΟΛΗ</a> </li>
		...
		<div id="main">
			<h2 id="page_title"> βλαβες σε αναμονη </h2> <br>
			<div id="view">
					<?php
